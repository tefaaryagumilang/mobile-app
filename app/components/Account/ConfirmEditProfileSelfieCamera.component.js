...
import styles from '../EmoneyJourney/EmoneyCamera.styles';
import {Toast} from '../../utils/RNHelpers.util';
import tracker from '../../utils/googleAnalytics.util';

class ConfirmEditProfileSelfieCamera extends Component {
  static propTypes = {
          ...
          <View style={styles.cameraInfo}>
            <View style={styles.sideContainerSelfie}>
              <Text style={styles.normalText}>
                {language.CAMERA__SELFIE}
              </Text>
            </View>
            <View style={styles.capture}>
              <View style={styles.mb20}>
                <Text style={styles.footerText}>
                  {language.CAMERA__SELFIE_FOOTER}
                </Text>
              </View>
...
export default ConfirmEditProfileSelfieCamera;