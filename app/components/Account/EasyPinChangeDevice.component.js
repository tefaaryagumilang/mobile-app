...
import easyPinStyles from './EasyPinChangeDevice.styles';
import Touchable from '../Touchable.component';
import styles from '../../components/OnboardingJourney/Onboarding.component.styles';
...
class LoginEasyPin extends Component {
  ...
  render () {
    const {isFaceRegistered, isFaceRecogEnabled,
          ...
          <View style={styles.rowEasyPINFormat}>
            <View>
              <Text style={styles.easypinHeaderTitle}>
                {language.VERIFY_EASYPIN__TITLE}
              </Text>
            </View>
            <View>
