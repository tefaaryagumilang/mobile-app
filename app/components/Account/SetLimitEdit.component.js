...
import styles from '../../components/Account/SetLimitEdit.styles';
...
class SetLimitEdit extends Component {
  ...
  render () {
    const {disabled, validationInput, debitAccountNo, debitAccountName, creditAccountNo, creditAccountName, errorNextTrx, errorNextDay, ...reduxFormProps} = this.props;
                    ...
                    <View>                      
                      <View style={styles.boxedInfoTransferTo}>  
                        ...
                        <View style={styles.rowPadding}> 
                          <Text style={styles.accTarget}>{creditAccountName}     -     {creditAccountNo}</Text>
                        </View>
                      </View>
                    </View>
                  </View>
