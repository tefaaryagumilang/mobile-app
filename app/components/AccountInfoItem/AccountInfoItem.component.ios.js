...
class AccountInfoItem extends React.Component {
  ...
  showDetail = () => () => {
    ...
    detailLockedAmount(accountNumber).then(() => {
      ...
      } else if (itemType === 'savingAccount') {
