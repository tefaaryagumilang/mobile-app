...
import styles from '../OnboardingJourney/EasyPinSetLimit.component.styles';
        ...
        <View>
          ...
          <View style={easyPinStyles.containerEasyPin}>
            <View style={easyPinStyles.inputOTPCOntainer}>
              <Field name={'easyPinsetLimit'} style={easyPinStyles.inputOTP} secureTextEntry={true} component={SmsOtpInput} submitHandler={this.handleValidate}/>
            </View>
