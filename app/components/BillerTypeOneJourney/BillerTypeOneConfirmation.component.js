...
export default class BillerTypeOneConfirmation extends Component {
  ...
  render () {
    const {accountNo = {}, resData = {}, dataDetail = [], isUseSimas, isADebit,
      biller = {}, handleSubmit, couponUse, goToCoupon,
      favoriteBill, billerFavorite, isNewBiller, isAutoDebit, autoDebitDate, invalid, disabled} = this.props;
    ...
    const billerNameDynatrae = isPostpaidTelco ? 'Postpaid Telco - Confirm Payment' : billerNameDt + ' - ' + 'Confirm Payment';
