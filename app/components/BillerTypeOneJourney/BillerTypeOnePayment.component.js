...
class BillerTypeOnePayment extends React.Component {
  ...
  render () {
    ...
    const billerName = isPostpaidTelco ? 'Postpaid Telco -  Next Payment ' + billerNameDt : billerNameDt + ' - ' + 'Next Payment';
    const sourceOfFund = isPostpaidTelco ? 'Postpaid Telco - open source account list' : billerNameDt + ' - ' + 'open source account list';
    return (
