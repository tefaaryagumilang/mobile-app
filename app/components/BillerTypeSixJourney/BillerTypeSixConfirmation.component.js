...
export default class BillerTypeSixConfirmation extends Component {
  ...
  render () {
    const {denomination = {}, amount = '', accountNo = {}, isUseSimas,
      ...
      goToCoupon, couponUse, favoriteBill, isLogin,
    ...
    let billerNameDynatrae;
    if (isPrepaidTelco) {
      billerNameDynatrae = 'Prepaid Telco - Confirm Payment';
    } else {
      billerNameDynatrae = 'Biller ' + billerNameDt + ' - ' + 'Confirm Payment';
    }
