...
import BillerTypeSixConfirmation from '../BillerTypeSixConfirmation.component';
...
describe('BillerTypeSixConfirmation component', () => {
  ...
  xit('easy pin should be shown', () => {
    const spy = jest.fn();
    const wrapper = shallow(<BillerTypeSixConfirmation handleSubmit={spy} triggerAuth={spy}/>);
  ...
  xit('easypin should submit', () => {
    const spy = jest.fn();
    const wrapper = shallow(<BillerTypeSixConfirmation handleSubmit={spy}/>);
