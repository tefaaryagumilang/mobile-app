...
class EmallAccounts extends React.Component {
  ...
  render () {
    const {accountNumber, productType, name, balances, getConfirmation, dynatrace} = this.props;
      ...
      <KeyboardAwareScrollView keyboardShouldPersistTaps='handled' extraHeight={120}>
        <View>
          <View style={styles.bgWhite}>
            <Touchable dtActionName={`${dynatrace} - Select Source Account`} onPress={getConfirmation}>
