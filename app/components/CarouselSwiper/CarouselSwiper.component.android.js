...
export default class extends Component {
  ...
  renderNextButton = () => {
    ...
    return (
      <TouchableOpacity onPress={this.renderPrevButtonComp}>
        <View>
          {button}
        </View>
      </TouchableOpacity>
  ...
  renderButton = () => {
    const {onButtonPress, onButtonProductPress, onPressLink} = this.props;
    return (
      <View style={styles.ButtonLogin}>
        <Touchable onPress={onPressLink} style={styles.containerBottomtext}>
          <Text style={styles.contentText}>
            {language.TERMS_CONDITION__PART_ONE}
            <Text style={styles.underlineText}>{language.TERMS_CONDITION__PART_TWO}</Text>
          </Text>
        </Touchable>
        <View  pointerEvents='box-none' style={styles.buttonMainSecond}>
          <SinarmasButtonOnboarding  style={styles.buttonLogin} onPress={onButtonPress}>
            <Text style={styles.buttonMainLoginUser}>{language.INTRODUCTION__NEW_BUTTON_ONE}</Text>
          </SinarmasButtonOnboarding>
        </View>
        <View  pointerEvents='box-none' style={styles.buttonMain}>
          <SinarmasButtonOnboarding text={language.INTRODUCTION__NEW_BUTTON_TWO} style={styles.mainbutton}  onPress={onButtonProductPress}/>
        </View>
      </View>
    );
  }
