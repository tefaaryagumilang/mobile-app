      ...
      <KeyboardAwareScrollView contentContainerStyle={styles.columnContainer} extraHeight={120}>
        <View style={styles.upperWrapper}>
          ...
          <View style={styles.row}>
            <View style={styles.mainTitle}>
              <Text style={styles.mainTitleText}>{language.CREATE_ACCOUNT__DATA_NOT_MATCH}</Text>
            </View>
            <View style={styles.check}><SimasIcon name='fail' style={styles.mainCheckLogo} size={26}/></View>
          </View>
        </View>
        <View>
        ...
        <View style={styles.buttonContainer}>
          <View style={styles.boxedInfo}>
            ...
            <Text style={styles.info}>{language.CREATE_ACCOUNT__BOX_INFORMATION}</Text>
          </View>
