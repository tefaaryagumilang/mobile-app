...
import styles from './SavingAccountOTP.style';
...
class OTPFormView extends Component {
  ...
  render () {
    ...
    return (
      <KeyboardAwareScrollView contentContainerStyle={styles.bodyContainerOTP} extraScrollHeight={100} enableOnAndroid={true}>
