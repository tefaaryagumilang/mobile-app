      ...
      <View style={{marginHorizontal: 20}}>
        {typeVoucher === 'EVOUCHER' ? // for vouchers from HHH or lucky dip
                  ...
                  <View style={styles.detailsContainer}>
                    ...
                    </View>
                    {
                      this.state.showButton && (isExpired || isRedeemed) ?
                        <Touchable dtActionName = 'Delete to E-voucher Order Item' onPress={this.onPressDelete(orderNumberFix, voucherIdFix)} style={styles.moveButton2}>
          ...
          : typeVoucher === 'GIVEAWAY' ? // for vouchers from giveaway
                      ...
                      }
                      {
                        codeVoucherDetermine ? // for giveaway, url is in voucherCode/id
                          <View style={styles.row}>
                            ...
                            <View style={styles.codePin}>
                              <Text numberOfLines={1} style={styles.textPin}>{voucherIdFix}</Text>
                              <Touchable dtActionName = 'Copy to E-Voucher Giveaway Order Item' onPress={wrapMethodInFunction(copyToCLipboard, voucherIdFix)}>
                                <SimasIcon name='copy' style={styles.copyIcon} size={15}/>
                              </Touchable>
                            </View>
                          </View>
            ...
            <View>
              <TouchableWithoutFeedback dtActionName = 'Detail Evoucher From My Order to Order Item' onPress={myOrderVoucherDetermine ? onPress : goToEvoucherDetail({...this.props, searchPath: 'GA', isFromMyOrder: true})}>
