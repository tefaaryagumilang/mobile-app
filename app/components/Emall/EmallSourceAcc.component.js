...
import styles from './EmallSourceAcc.styles';
...
class EmallSourceAcc extends React.Component {
  static propTypes = {
  ...
  renderListItem = ({item}) => (<EmallAccounts {...item} getConfirmation={this.renderListItemConfirmation(item)} />);
