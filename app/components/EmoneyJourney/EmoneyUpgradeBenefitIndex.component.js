...
class EmoneyUpgradeBenefitIndex extends React.Component {
  static propTypes = {
  ...
  render () {
    const {movetoForm, isTransfer, isCashless} = this.props;
    return (
      <KeyboardAwareScrollView keyboardShouldPersistTaps='handled' contentContainerStyle={styles.bodyContainerWithNoTerms} extraScrollHeight={100} enableOnAndroid={true}>
        <View style={styles.spaceContainer}>
          {isTransfer || isCashless && <View style={styles.paddingHeader}/>}
        ...
        <View style={styles.buttonWrapperHorizontal}>
          <SinarmasButton onPress={movetoForm}>
...
export default EmoneyUpgradeBenefitIndex;
