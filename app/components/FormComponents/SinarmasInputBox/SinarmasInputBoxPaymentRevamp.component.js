...
import styles from './SinarmasInputBoxPaymentRevamp.styles';
...
class SinarmasInputBoxRevamp extends Component {
  ...
  render () {
    const {isInputAmount, input = {}, value, onFocus = noop, onBlur = noop, onChangeText = noop, borderOff, onInputChange = noop, disabled = false, placeholder = '', isUseSuccessInputText = false, typeField = 'text', setNewUsernameValue, setNewPasswordValue, usernameValue = '', passwordValue = '', oldPassword = '', validationInput, iconName = '', leftIcon = '', textPosition = '', ...extraProps} = this.props;
    ...
    const textInput = disabled && !isInputAmount ? styles.inputStyleDisabledCenter : isInputAmount ? styles.inputAmount : disabled && isInputAmount ? styles.inputAmount : styles.inputStyleCenter;
