...
import SinarmasInputBox from '../SinarmasInputBoxPaymentRevamp.component';
...
describe('FormComponent: SinarmasInputBox component', () => {
  it('renders correctly', () => {
    const tree = renderer.create(<SinarmasInputBox/>).toJSON();
    expect(tree).toMatchSnapshot();
  });

  describe('SinarmasInputBox', () => {
    const wrapper = shallow(<SinarmasInputBox value={'test value'} onInputChange={onInputChangeSpy} onBlur={onBlurSpy} onFocus={onFocusSpy} onChangeText={onChangeTextSpy} ref/>);
