...
import SinarmasInputBoxNew from '../SinarmasInputBoxNew.component';
...
describe('FormComponent: SinarmasInputBoxNew component', () => {
  it('renders correctly', () => {
    const tree = renderer.create(<SinarmasInputBoxNew/>).toJSON();
    expect(tree).toMatchSnapshot();
  });

  describe('SinarmasInputBoxNew', () => {
    const wrapper = shallow(<SinarmasInputBoxNew value={'test value'} onInputChange={onInputChangeSpy} onBlur={onBlurSpy} onFocus={onFocusSpy} onChangeText={onChangeTextSpy} ref/>);
