...
import styles from '../../components/FundTransferJourney/SetEditLimitFundTransfer.styles';
...
class SetLimitEdit extends Component {
  ...
  render () {
    const {disabled, validationInput, debitAccountNo, debitAccountName, payeeNumber, payeeName, errorNextTrx, errorNextDay, ...reduxFormProps} = this.props;
                    ...
                    <View>
                      <View style={styles.rowProduct}>
                        ...
                        <View style={styles.end}>
                          <Text style={styles.debitName}>{debitAccountName}</Text>
                          <Text style={styles.accNo}>{debitAccountNo}</Text>
                        </View>
                      </View>                     
                    </View>
                  </View>
                    ...
                    <View>
                      <View style={styles.boxedInfoTransferTo}>  
                        ...
                        <View style={styles.rowPadding}> 
                          ...
                          <Text style={styles.accTarget}>{payeeName}    -    {payeeNumber}</Text>
                        </View>
                      </View>
                    </View>
                  </View>
