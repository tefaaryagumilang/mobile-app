...
import styles from './GenerateCodeOfflineMain.styles';
import Touchable from '../Touchable.component';
import SimasIcon from '../../assets/fonts/SimasIcon';
import {result} from 'lodash';
import {language} from '../../config/language';

class GenerateCodeOfflineMain extends React.Component {
  static propTypes = {
    ...
    return (
      <View style={styles.containerWhite}>
        <View style={styles.containerCodeMenu}>
          {flagLKDPurchase ?
            <View>
              <Touchable onPress={goToGenerateMain(result(transactionTypeLKD, 'payOffline', ''))}>
          ...
          {flagLKDCashOut ?
            <View>
              <Touchable onPress={goToGenerateMain(result(transactionTypeLKD, 'cashOutOffline', ''))}>
                <View style={styles.codeBorder}>
                  <View style={styles.imageLeft}>
                    <SimasIcon name={'biller-withdrawal'} style={styles.iconColor} size={38}/>
                  </View>
                  <View style={styles.imageCenter}>
...
export default GenerateCodeOfflineMain;
