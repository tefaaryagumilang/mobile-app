...
class InvestmentComponent extends React.Component {
  ...
  render () {
    ...
    const produkCode = startsWith((mataUang), 'IDR');
    ...
    return (
      <View style={styles.carouselContainer}>
        ...
        <View style={styles.rowDetails}>
          <View>
            {produkCode ?
              <Text style={styles.detailTitle}>{language.INQUIRY__SIL_INFO_PERIODE_MTI_NEW}</Text>
              :
        ...
        <View style={styles.rowDetails}>
          <View style={styles.leftContainer}>
            {produkCode ?
              <Text style={styles.detailTitle}>{language.SIL__SIMAS_MTI_PERIOD_NEW}</Text>
              :
        ...
        <View style={styles.rowDetails}>
          <View>
            {produkCode ?
              <Text style={styles.detailTitle}>{language.SIL__SIMAS_MTI_PERIOD_DATE_NEW}</Text>
              :
