...
class DrawItem extends React.Component {
  ...
  render () {
    const {style, luckyDrawName, quantityOfLuckyDraw, startDatePeriode, endDatePeriode, description, dateOfDrawing} = this.props;
    const newDate = new Date();
    const currentDate = moment(newDate).format('D MMM YYYY');
    const dateDrawing = moment(dateOfDrawing).format('D MMM YYYY');
    const isDrawing = currentDate === dateDrawing;
        ...
        <Touchable onPress={this.getTnC}>
          ...
          { isDrawing === true ?
            <View style={styles.buttonContainer}>
              <SinarmasButton text={language.LUCKYDRAW__WINNER} onPress={this.getOffer}/>
            </View>
            : null }
        </Touchable>
        ...
        <View style={styles.containerItem}>
          <View style={styles.touchableRowUndian} >
            ...
            <View style={styles.sumUndianstyle} >
              ...
              <Text style={styles.styleTextNumber}>{quantityOfLuckyDraw}</Text>
            </View>
          </View>
