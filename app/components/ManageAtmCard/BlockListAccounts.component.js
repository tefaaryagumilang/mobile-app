            ...
            <View style={styles.offerContainer}>
              <View style={styles.cardContainer2}>
                ...
                <View style={styles.detailContainer}>
                  ...
                  <SinarmasButton dtActionName = 'Selected to Blocked ATM Card' style={styles.button2} onPress={getPopUpBlocked(accName, accountNo, idCard, cardNo, contractCard, bankBranchName, nameFull)} >
