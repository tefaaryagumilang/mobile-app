...
import styles from './CommonOTP.component.styles';
        ...
        <View style={styles.columnContainer}>
          ...
          <View style={styles.containerDetail}>
            ...
            <View style={styles.otpDetail}>
              <View style={styles.modalTextLeftContainer}><Text style={styles.otpDetailText}>1.</Text></View>
              <View style={styles.modalTextRightContainer}><Text style={styles.otpDetailText}>{language.ONBOARDING__OTP_MORE_INFO_SUBTITLE}</Text></View>
            </View>
            <View style={styles.otpDetail}>
              <View style={styles.modalTextLeftContainer}><Text style={styles.otpDetailText}>2.</Text></View>
              <View style={styles.modalTextRightContainer}><Text style={styles.otpDetailText}>{language.ONBOARDING__OTP_MORE_INFO_SUBTITLE_2}</Text></View>
            </View>
          </View>
        </View>
