...
import styles from './AlfacartTnc.styles';
...
class AlfacartTnc extends React.Component {
  static propTypes = {
  ...
  render () {
    const {goToNextPage = noop, nav, url} = this.props;
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <SinarmasButton disabled={!this.state.disable} onPress={goToNextPage(nav)}>
            <Text style={styles.nextButton}>{language.ALFACART_BUTTON_TNC}</Text>
          </SinarmasButton>
        </View>
      </View>
    );
