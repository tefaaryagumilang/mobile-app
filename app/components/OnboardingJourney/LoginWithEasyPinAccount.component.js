...
class LoginEasyPin extends Component {
  ...
  render () {
    const {forgotEasyPin, isFaceRegistered, isFaceRecogEnabled,
      isUsingFaceRecog, isUsingFingerprint, hasFingerprint, loginFaceRecognition,
      showFingerprintModalIOS, isTransfer, isCashless, addStyleContinue,
    ...
    return (
      <KeyboardAwareScrollView keyboardShouldPersistTaps='handled'  contentContainerStyle={styles.bodyContainerEasyPin} extraHeight={120}>
        ...
        <View style={addStyleContinue ? styles.buttonOtpSubmitPlus : styles.buttonOtpSubmit}>
...
LoginEasyPin.propTypes = {
  ...
  addStyleContinue: PropTypes.bool
};
