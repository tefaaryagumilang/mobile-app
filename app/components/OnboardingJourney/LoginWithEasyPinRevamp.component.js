...
import easyPinStyles from './EasyPinCreationRevamp.component.styles';
...
class LoginEasyPinRevamp extends Component {
  handleValidate = () => {
    Keyboard.dismiss();
  }
...
export default LoginEasyPinRevamp;
