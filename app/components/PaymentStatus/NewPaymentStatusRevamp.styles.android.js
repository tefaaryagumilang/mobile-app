...
export default {
  ...
  methodExplanation: [fontSizeSmallStyle, {
    color: theme.darkBlue,
    fontFamily: 'Roboto',
    fontSize: 13,
    marginTop: 15
  }],
  transactionDetailsHeader: [fontSizeSmallStyle, {
    color: theme.black,
    fontFamily: 'Roboto',
    fontWeight: 'bold',
    fontSize: 18,
  ...
  accNumberContainerCollapsible: {
    paddingVertical: 10,
    marginVertical: 10,
    width: width * 0.85,
  },
  accNumberContainerDeposit: {
    backgroundColor: '#f9f8fd',
    flexDirection: 'column',
    paddingVertical: 10,
    paddingHorizontal: 10,
