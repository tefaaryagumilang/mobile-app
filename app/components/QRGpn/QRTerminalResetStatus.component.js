...
import styles from './QRTerminalResetStatus.styles';
      ...
      <View style={styles.container}>
        <View style={styles.redContainer}>
          ...
          <View style={styles.regCont}>
            <View>
              <Text style={styles.merchantText}>{language.QR_GPN__TERMINALRES_SUCCESS_01}</Text>            
              <Text style={styles.merchantText}>{language.QR_GPN__TERMINALRES_SUCCESS_02}</Text>
              <Text style={styles.merchantText}>{language.QR_GPN__TERMINALRES_SUCCESS_03}</Text>                          
            </View>
          ...
          <View style={styles.row}>
            ...
            <View>
              ...
              <View style={styles.info2}>                
                <Text style={styles.txt}>{language.QR_GPN__TERMINALRES_SUCCESS_06}</Text>                
                <Text style={styles.txt}>{language.QR_GPN__TERMINALRES_SUCCESS_07}</Text>                
              </View>
            </View>  
          </View>
        </View>   
