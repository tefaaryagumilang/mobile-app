...
class Offers extends React.Component {
  static propTypes = {
    ...
    checkToogleMenuCMI: PropTypes.string,
    checkToggleMenuUnipin: PropTypes.string,
  }
  static defaultProps = {
    offers: [],
    onOfferClick: noop
  ...
  renderOffer = (offerDetails, i) => {
    const {goToTncAlfacart = noop, goToTncSimasCatalog = noop, goToAlfacart = noop, goToMerchantStore, goToTncUnipin, checkToogleMenuKoperasi, checkToogleMenuUV, checkToogleMenuAlfa, checkToogleMenuCMI, checkToggleMenuUnipin} = this.props;
    ...
    const TouchableLifestyle = nameLifestyle === 'UVOffer' ? goToTncSimasCatalog : nameLifestyle === 'AlfaCartOffer' ?  goToTncAlfacart : nameLifestyle === 'KoperasiOffer' ? goToAlfacart : nameLifestyle === 'CMIOffer' ? goToMerchantStore(offerDetails.offersCode) : nameLifestyle === 'UnipinOffer' ? goToTncUnipin : noop;
    ...
    return (
      <View>
        {
          categoryLifeStyle ?
            toogleTouchableLifestyle && <Offer {...offerDetails} type='offer' key={i} onPress={toucahbleOffers} titleLifestyle={titleLifestyle} 
