...
const QuickPickListItem = ({text, subtext, secondaryText, onPress, disabled, checked, ...extraProps}) =>
  (<Touchable onPress={onPress} disabled={disabled} checked={checked}>
    <View style={styles.container} {...extraProps}>
      ...
      {checked ?
        <SimasIcon name='check-black' style={styles.icon} size={25}/>
        :
        null
      }
    </View>
