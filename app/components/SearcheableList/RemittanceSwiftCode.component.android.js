              ...
              <View style={styles.containerUtama}>
                <View style={styles.flexGrey}>
                  ...
                  <View style={styles.buttonBottom}>
                    <SinarmasButton disabled={isEmptySwiftCode} onPress={this.onNextClick} text={language.SERVICE__NEXT_BUTTON} style={styles.nextButton} dtActionName={dynatrace ? dynatrace + ' - Input Swift Code - Click Next' : 'Input Swift Code - Click Next'}/>
                  </View>
                </View>
              </View>
              : null
