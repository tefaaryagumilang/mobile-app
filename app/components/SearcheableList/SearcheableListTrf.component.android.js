...
class SearcheableListTrf extends Component {
  ...
  render () {
    const {btnNewAcc = '', labelTitlle = '',
      ...
      placeholderEmail, placeholderPhone, placeholderBiFast, textKeyBiFast, SetBiFast, dtActionName, dtActionNameHistory, dynatrace, dtActionNameMerchant, billerFavorite} = this.props;
            ...
            <View style={onNextClick ? styles.inputAcc : styles.inputWithPaddingHorizontalAcc}>
              {isCardless ?
                <View style={styles.textInputContainerPadding}>
                  ...
                  />
                  <Touchable dtActionName='CONTACT LIST' onPress={this.getContact} style={styles.iconContact}>
