...
import SearcheableList from '../SearchableListAirport.component';
...
const wrapper = shallow(<SearcheableList {...props}/>);

describe('SearcheableList component', () => {
  it('renders correctly', () => {
    const tree = renderer.create(<SearcheableList />).toJSON();
  ...
  describe('Enabled Next button', () => {
    const wrapper = shallow(<SearcheableList {...props} onNextClick={onNextClickSpy}/>);
