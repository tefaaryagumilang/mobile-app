...
import SearchableListSetLimit from '../../components/Account/SearchableListSetLimitHighValue.component';
...
const mapDispatchToProps = (dispatch) => ({
  saveForListSetLimit: (item) => {
    ...
    dispatch(change('highValueTransfer', 'name', name));
    const accountNumber = result(item, 'accountNumber', '');
    dispatch(change('highValueTransfer', 'accountNumber', accountNumber));
