...
const mapStateToProps = (state, props) => ({
  accountsBiller: getTransferPossibleAccountsLKD(result(state, 'accounts', []), 'bp'),
  accountsTransfer: getTransferPossibleAccountsLKD(result(state, 'accounts', []), 'ft', result(props, 'navigation.state.params.payee', {})),
});
