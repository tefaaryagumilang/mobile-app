...
import {triggerAddLimit} from '../../state/thunks/common.thunks';
import {goToEditSetLimitFundTransfer} from '../../state/thunks/fundTransfer.thunks';

const formConfig = {
  form: 'SetLimitEasyPinEditFund',
  ...
  onSubmit: (values, dispatch, {sendVerification}) => {
    ...
    dispatch(triggerAddLimit('CustomLimit', null, false, 'AuthTransferSetLimit', params));
  },
  validate: (values) => ({
...
const mapDispatchToProps = (dispatch) => ({
  ...
  triggerAuth: (params) => {
    dispatch(triggerAddLimit('CustomLimit', null, true, false, 'AuthTransferSetLimit', params));
  },  sendVerification: (data) => {
    dispatch(goToEditSetLimitFundTransfer(data));
  }, 
  dispatch 
});
