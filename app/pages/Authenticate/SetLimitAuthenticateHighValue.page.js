...
import EasyPinSetLimit from '../../components/Authenticate/SetLimitEasyPinHighValue.component';
...
import {triggerAddLimit, highValueSetLimit} from '../../state/thunks/common.thunks';


const formConfig = {
  form: 'SetLimitEasyPinHighValue',
  ...
  onSubmit: (values, dispatch, {sendVerification}) => {
    ...
    dispatch(triggerAddLimit('CustomLimit', null, false, 'AuthSetLimit', params));
  },
  validate: (values) => ({
...
const mapDispatchToProps = (dispatch) => ({
  ...
  triggerAuth: (params) => {
    dispatch(triggerAddLimit('CustomLimit', null, true, false, 'AuthSetLimit', params));
  },
  sendVerification: () => {
    dispatch(highValueSetLimit());
  }, 
  dispatch 
});
