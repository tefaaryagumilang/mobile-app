...
import FundTransferPayment from '../../components/BIFast/UnlinkProxyBIFast.component';
...
import {unlinkProxy} from '../../state/thunks/biFast.thunks';
...
class FundTransferPaymentPage extends Component {
  ...
  confirmationGoFunc = () => {
    const {user, detailByCustNo, selectedAccount, goToConfirmation, formValues} = this.props;
    goToConfirmation(user, detailByCustNo, selectedAccount, formValues);
  }
  ...
  render () {
    ...
    return (
      <DecoratedFundTransferPayment accountList={accounts} onNextPress={this.onNext} payee={payee}
        ...
        tickOnclose={this.tickOnclose} setNewSof={setNewSof}
...
const mapStateToProps = (state) => ({
  ...
  formValues: result(state, 'form.UnlinkProxyForm.values', {}),
...
const mapDispatchToProps = (dispatch) => ({
  ...
  goToConfirmation: (user, detailByCustNo, selectedAccount, formValues) => {
    dispatch(unlinkProxy(user, detailByCustNo, selectedAccount, formValues));
  },
  ...
  setNewSof: (value) => {
    dispatch(change('UnlinkProxyForm', 'removeAcc', value));
  },
  dispatch
});
