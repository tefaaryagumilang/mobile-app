...
const formConfig = {
  ...
  onSubmit: (values, dispatch, {denomination = {}, navigation, payBill, currentAmount, confirmData, isLogin, isSyariah, couponCheck, autoDebitDate, favoriteBill, billerFavorite, resData}) => {
...
class BillerTypeNineConfirmationPage extends React.Component {
  ...
  payBill = () => {
    const {payGenericBillTypeNine, isLogin, navigation, isUseSimas, isAutoDebit, setAsAutodebit, autoDebitDate, favForm} = this.props;
  ...
  render () {
    ...
    const {triggerAuth, removeCoupon, timeEndCoupon, gapTimeServer, navigation,
      ...
      billerFavorite, currency, isLogin, couponCheck, isAutoDebit, autoDebitDate, favForm} = this.props;
    ...
    return <ConnectedForm {...navParams} goToCoupon={this.goToCoupon} timeEndCoupon={timeEndCoupon} gapTimeServer={gapTimeServer} removeCoupon={removeCoupon} navigation={navigation}
      ...
      state={state} couponCheck={couponCheck} isAutoDebit={isAutoDebit} isADebit={isADebit} autoDebitDate={autoDebitDate} isFavorite={isFavorite} favForm={favForm} disabled={disabled}/>;
...
const mapStateToProps = (state) => ({
  ...
  favForm: result(state, 'form.BillerTypeNineConfirmationForm.values', ''),
});
