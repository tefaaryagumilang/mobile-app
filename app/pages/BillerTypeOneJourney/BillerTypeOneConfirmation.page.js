...
const formConfig = {
  ...
  onSubmit: (values, dispatch, {payBill, denomination, navigation, billAmount, amount, isPrepaidBiller, currentAmount, confirmData, isLogin, isSyariah, couponCheck, autoDebitDate, favoriteBill, billerFavorite, resData}) => {
...
class BillerTypeOneConfirmationPage extends React.Component {
  ...
  payBill = () => {
    const {payGenericBillTypeOne, isLogin, navigation, isUseSimas, isAutoDebit, setAsAutodebit, autoDebitDate, favForm} = this.props;
...
const mapStateToProps = (state) => ({
  ...
  favForm: result(state, 'form.BillerTypeOneConfirmationForm.values', ''),
