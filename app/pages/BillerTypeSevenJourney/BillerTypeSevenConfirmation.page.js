...
const formConfig = {
  ...
  onSubmit: (values, dispatch, {isPrepaidBiller = true, navigation, denomination = {}, billAmount, amount, payBill, currentAmount, confirmData, isLogin, isSyariah, couponCheck, autoDebitDate, favoriteBill, billerFavorite, resData}) => {
...
class BillerTypeSevenConfirmationPage extends React.Component {
  ...
  payBill = () => {
    const {payGenericBillTypeSeven, isLogin, navigation, isUseSimas, isAutoDebit, setAsAutodebit, autoDebitDate, favForm} = this.props;
  ...
  render () {
    ...
    const {removeCoupon, timeEndCoupon, gapTimeServer, navigation, timeStartCoupon, dateEndCoupon, state, dateStartCoupon, usingFromLine, minAmount, maxAmount, showFavorite, favoriteBill, removeFavorite, billerFavorite, currency, isLogin, couponCheck, formValues = {}, isAutoDebit, autoDebitDate, favForm} = this.props;
...
const mapStateToProps = (state) => ({
  ...
  favForm: result(state, 'form.BillerTypeSevenConfirmationForm.values', ''),
});
