...
import BillerTypeTenIndex from '../../components/BillerTypeTenJourney/BillerTypeTenIndex.component';
...
const mapDispatchToProps = (dispatch) => ({
  ...
  selectHistory: (subscriberNo) => {
    dispatch(change('BillerTypeTenIndexForm', 'subscriberNo', subscriberNo));
  },
  getBillpayHistory: () => dispatch(getBillpayHistory()),
});

const formConfig = {
  form: 'BillerTypeTenIndexForm',
...
const BillerTypeTenIndexForm = reduxForm(formConfig)(BillerTypeTenIndex);

class BillerTypeTenIndexPage extends Component {
  static propTypes = {
...
const ConnectedBillerTypeTenIndexPage = connect(
  mapStateToProps,
  mapDispatchToProps
)(BillerTypeTenIndexPage);
export default ConnectedBillerTypeTenIndexPage;
