...
class BillerTypeThreeConfirmationPage extends React.Component {
  ...
  payBill = () => {
    const {payGenericBillTypeThree, isLogin, navigation, isUseSimas,  isAutoDebit, setAsAutodebit, autoDebitDate, favForm} = this.props;
...
const mapStateToProps = (state) => ({
  ...
  favForm: result(state, 'form.BillerTypeThreeConfirmationForm.values', ''),
