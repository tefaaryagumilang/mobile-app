...
import BillerTypeThreeIndex from '../../components/BillerTypeThreeJourney/BillerTypeThreeIndex.component';
...
const mapDispatchToProps = (dispatch) => ({
  ...
  selectHistory: (subscriberNo) => {
    dispatch(change('BillerTypeThreeIndexForm', 'subscriberNo', subscriberNo));
  },
  getBillpayHistory: () => dispatch(getBillpayHistory()),
});

const formConfig = {
  form: 'BillerTypeThreeIndexForm',
  ...
  onSubmit: (values, dispatch, {navigation}) => {
    ...
    dispatch(
      NavigationActions.navigate({
        routeName: 'BillerTypeThreePayment',
...
const BillerTypeThreeIndexForm = reduxForm(formConfig)(BillerTypeThreeIndex);

class BillerTypeThreeIndexPage extends Component {
  static propTypes = {
...
const ConnectedBillerTypeThreeIndexPage = connect(
  mapStateToProps,
  mapDispatchToProps
)(BillerTypeThreeIndexPage);
export default ConnectedBillerTypeThreeIndexPage;
