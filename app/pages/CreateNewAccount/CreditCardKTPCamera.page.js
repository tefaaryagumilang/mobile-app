...
import CameraView from '../../components/CreateNewAccount/CreditCardKTPCamera.component';
import result from 'lodash/result';
import {reduxForm} from 'redux-form';
import {generatePhotoKTP} from '../../state/thunks/ccEform.thunks';
...
const mapDispatchToProps = (dispatch) => ({
  setImage: (data) => {
    ...
    dispatch(NavigationActions.navigate({routeName: 'ImageConfirmation', params: {data: data.base64, code: data.pictureOrientation, nextFunction, route: 'CreditCardKTPCamera'}}));
  },
  showSpinner: () => {
