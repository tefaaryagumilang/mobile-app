...
import CreateAccountOTP from '../../components/CreateNewSavingAccount/SavingAccountOTP.component';
import {resendOtpEform, verifyOtpEform} from '../../state/thunks/savingAccount.thunks';
...
const mapStateToProps = ({currentLanguage, transRefNum, form}) => ({
  currentLanguage,
  mobileNumber: maskingMobileNumber(result(form, 'identifyUserSavingForm.values.phone', '')),
  transRefNum
});
