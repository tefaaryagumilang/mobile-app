...
import FlightAvailability1 from '../FlightAvailability1.page';
...
const DecoratedForm = reduxForm({form: 'testForm'})(FlightAvailability1);

const mockedDate = new Date(1989, 7, 18);
global.Date = jest.fn(() => mockedDate); // eslint-disable-line no-undef

describe('FlightAvailability1 page', () => {
