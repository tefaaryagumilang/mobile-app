...
import SetLimitEdit, {fields}  from '../../components/FundTransferJourney/SetEditLimitFundTransfer.component';
...
import {setupFromSetLimit} from '../../state/thunks/fundTransfer.thunks';
...
const formConfig = {
  ...
  onSubmit: (values, dispatch, {navigation}) => {  
    ...
    dispatch(setupFromSetLimit(payeeName, payeeNumber, bank, currency, id, targetType, transferType, accountType)); 
...
const mapStateToProps = (state) => ({    
  ...
  errorNextTrx: result(state, 'form.fromSetLimit.values.limitPerTransaction', 0), 
  errorNextDay: result(state, 'form.fromSetLimit.values.limitPerDay', 0),
