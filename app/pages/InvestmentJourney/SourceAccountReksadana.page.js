...
import SourceAccount from '../../components/InvestmentJourney/SourceAccountReksadana.component';
import {getTransferPossibleAccounts, getTransferPossibleAccountsReksadana} from '../../utils/transformer.util';
...
const mapStateToProps = (state, props) => ({
  accountsBiller: getTransferPossibleAccountsReksadana(result(state, 'accounts', []), 'bp', result(props, 'navigation.state.params.item', {})),
  accountsTransfer: getTransferPossibleAccounts(result(state, 'accounts', []), 'ft', result(props, 'navigation.state.params.payee', {}), result(props, 'navigation.state.params.item', {})),
});
