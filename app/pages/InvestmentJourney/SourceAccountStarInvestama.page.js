...
import SourceAccount from '../../components/InvestmentJourney/SourceAccountStarInvestama.component';
import {getTransferPossibleAccounts, getTransferPossibleAccountsStarInvestama} from '../../utils/transformer.util';
...
const mapStateToProps = (state, props) => ({
  ...
  accountsTransfer: getTransferPossibleAccountsStarInvestama(result(state, 'accounts', []), 'ft', result(props, 'navigation.state.params.payee', {}), result(props, 'navigation.state.params.currency', {}), result(props, 'navigation.state.params.isOpenCrossCurrency', {})),
});
