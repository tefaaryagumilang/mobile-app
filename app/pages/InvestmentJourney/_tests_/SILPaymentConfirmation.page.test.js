...
import SILPaymentConfirmation from '../SILPaymentConfirmation.page';
...
const DecoratedForm = reduxForm({form: 'testForm'})(SILPaymentConfirmation);

const mockedDate = new Date(1989, 7, 18);
global.Date = jest.fn(() => mockedDate); // eslint-disable-line no-undef

describe('SILPaymentConfirmation page', () => {
