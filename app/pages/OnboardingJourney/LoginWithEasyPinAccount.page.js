...
import {login as loginThunk, clearAndResetPasswordBurgerMenu, loginToAccount} from '../../state/thunks/onboarding.thunks';
...
const formConfig = {
  ...
  onSubmit: (values, dispatch, {isLockedDevice, isOBM, isOBMDashboard, isOBMActive}) => {
    if (isOBMActive === 'TRUE') {
      dispatch(loginToAccount(values, isLockedDevice, isOBM, isOBMDashboard));
    } else {
