...
import LoginEasyPinForm from '../../components/OnboardingJourney/LoginWithEasyPinRevamp.component';
...
class LoginWithEasyPinRevamp extends Component {
  state = {
    visible: false
  }
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(LoginWithEasyPinRevamp);
