...
import SelfieComponent from '../../components/OpeningAccountJourney/CameraSelfieRetake.component';
...
class SelfieComponentPage extends Component {
  ...
  render () {
    ...
    const dataAccount = result(navigation, 'state.params.dataActivation', {});
    return (
